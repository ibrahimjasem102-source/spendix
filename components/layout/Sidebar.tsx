  ...
  return (
    <aside className={cn(
      ...
      <div className="modern-surface flex min-h-0 flex-1 flex-col rounded-[24px]">
        ...
        {/* Logo */}
        <div className={cn(
          "flex h-[68px] shrink-0 items-center border-b border-[hsl(var(--border))]",
                  ...
                  <div className="space-y-1">
                    {items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          {active && !collapsed && (
                            <span className="absolute inset-y-2 start-0 w-1 rounded-full bg-cyan-300" />
                          )}
        ...
        <div className="border-t border-[hsl(var(--border))] p-2">
          {!collapsed && userEmail && (
            <div className="mb-1 flex items-center gap-3 rounded-2xl bg-[hsl(var(--bg-input))] px-3 py-2.5">
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-xs font-bold text-[hsl(var(--text-1))]">{userEmail}</p>
          ...
          <button
            ...
            className={cn(
              "flex min-h-[42px] w-full items-center gap-3 rounded-2xl px-3 text-sm font-semibold text-[hsl(var(--text-3))] hover:bg-rose-400/10 hover:text-rose-300 transition-colors",
              collapsed && "justify-center px-0"
            )}
          >
          ...
          <button
            onClick={toggle}
            className={cn(
              "mt-1 flex min-h-[38px] w-full items-center gap-3 rounded-2xl px-3 text-xs font-semibold text-[hsl(var(--text-3))] hover:bg-[hsl(var(--bg-input))] hover:text-[hsl(var(--text-1))] transition-colors",
              collapsed && "justify-center px-0"
            )}
          >
            {collapsed
